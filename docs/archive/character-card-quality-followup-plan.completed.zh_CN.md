...
归档状态：本计划的基础实现和本轮真实素材调优已完成。本文保留角色卡编译上下文分层、冲突消解、质量评估强化和真实素材回归的阶段性决策、边界和验收记录；后续若出现新的角色卡质量偏差，应先核对当前代码和稳定参考文档，再按需要新建专项或更新当前 TODO。
...
- 静态检查通过。
- 手动或脚本验证能证明原 TODO P1 第 3、4 项不再只停留在文档层。
...
- 原 TODO P1 第 3、4 项完成后迁入已完成区，或保留未完成残项。
