...
归档状态：本文档保留真实视频预览接入、`preview__` 产物隔离和早期预览计划的详细完成记录。后续文本、字幕、音频、图片、漫画和视频+字幕覆盖已由 `preview-real-result-followup-plan.completed.zh_CN.md` 与路线 03 完成记录承接；当前剩余任务以 `docs/plans/TODO.zh_CN.md` 为准。
