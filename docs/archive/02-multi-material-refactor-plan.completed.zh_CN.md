...
归档状态：路线 02 已完成并移出当前执行队列，本文保留 plan-first 重构、四媒体类型边界、派生成果层和路线 03 交接矩阵的历史记录。当前架构事实以代码、各级 `ARCHITECTURE.md` 和 `docs/reference/extraction-workflow.zh_CN.md` 为准。
